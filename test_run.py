...
for k in range(ngal):
    ...
    gal_tmp = cosmosCat.makeGalaxy(index=index, gal_type='real', rng=ud, noise_pad_size=11.3)
    ...
    out_uids[k] = k
    out_gids[k] = index
    out_mags[k] = gals_mags[index]
    out_flux[k] = gals_flux[index][0]
    out_phtz[k] = gals_zphot[index]
